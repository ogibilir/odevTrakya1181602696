...
class MovieDetails extends React.Component{
  ...
  getMovieDetails = (id) =>{
    let url = "https://api.themoviedb.org/3/movie/"+id+"?api_key="+Keys+"&language=tr".replaceAll(" ","");
  ...
  getCredits = (id) =>{
    let url = "https://api.themoviedb.org/3/movie/"+id+"/credits?api_key="+Keys+"&language=tr".replace(" ","");
    Axios.get(url).then(res=>{
      this.setState({
        cast: res.data
      })
  ...
  getSimilarMovies = (id) =>{
    let url = "https://api.themoviedb.org/3/movie/"+id+"/similar?api_key="+Keys+"&language=tr&page=1".replace(" ","");
    Axios.get(url).then(res=>{
      this.setState({
  ...
  getVideos = (id) =>{
    let url = "https://api.themoviedb.org/3/movie/"+id+"/videos?api_key="+Keys+"&language=trS&page=1".replace(" ","");
    Axios.get(url).then(res=>{
      this.setState({
        videos: res.data,
      })
  ...
  getReviews = (id) =>{
    let url = "https://api.themoviedb.org/3/movie/"+id+"/reviews?api_key="+Keys+"&language=tr&page=1".replace(" ","");
    Axios.get(url).then(res=>{
      this.setState({
        reviews: res.data,
      })
